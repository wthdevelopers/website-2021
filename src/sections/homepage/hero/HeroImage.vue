  ...
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" id="cityscape" viewBox="0 0 3089.9 1306.4">
      <g id="cityscape-base">
        ...
        <path
          fill="#c36"
          d="M2709 1140c-2 4-6 2-9 2h-125c3-3 7-1 10-1h112l12-1z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#7ebcad"
        ...
        <path
          fill="#93d1b3"
          d="M2705 1664l-22-30h24v23c0 2 1 5-2 7z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#2132c7"
        ...
        <path
          fill="#5f7fc1"
          d="M2993 1758h-2c-2-1-2-2-2-4a7 7 0 014 4z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#fff"
        ...
        <path
          fill="#94d3b2"
          d="M2473 1768c3 6 2 12 2 18-4-5-1-12-2-18z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#808bde"
        ...
        <path
          fill="#0014bf"
          d="M293 1758l10 4 2 2c-2 3-4 3-6 1s-5-4-6-7z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#7e8add"
          d="M3015 1828v-66-57c0-3 0-8 4-8s2 5 2 8v57l1 66z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#d65c85"
        ...
        <path
          fill="#94d3b2"
          d="M2025 1683v-5q3 2 0 5zM2023 1693l2-3v2z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#8290dc"
        ...
        <path
          fill="#1426c4"
          d="M2841 1376c-5 0-8-4-12-6v-4c5 2 13 1 12 10z"
          transform="translate(-1 -530)"
        ></path>
        <path
          fill="#d65c85"
        ...
        <path
          fill="#94d3b2"
          d="M2489 1709a2 2 0 01-2 1v-1a3 3 0 012 0z"
          transform="translate(-1 -530)"
        ></path>
      ...
      <g id="cityscape-lights-pink-one" fill="#d65c85">
        <path
      ...
      <g id="cityscape-lights-pink-two" fill="#d65c85">
        <path
      ...
      <g id="cityscape-lights-pink-three" fill="#d65c85">
        <path
      ...
      <g id="cityscape-lights-blue-one" fill="#2132c7">
        <path
      ...
      <g id="cityscape-lights-blue-two" fill="#2132c7">
        <path
      ...
      <g id="cityscape-lights-blue-three" fill="#2132c7">
        <path
      ...
      <g id="cityscape-stars-one" fill="#f9f458">
        <path
      ...
      <g id="cityscape-stars-two" fill="#f9f458">
        <path
      ...
      <g id="cityscape-stars-three" fill="#f9f458">
        <path
...
#cityscape-lights-blue-one > path,
#cityscape-lights-blue-two > path,
#cityscape-lights-blue-three > path {
  opacity: var(--lights-blue-opacity);
  fill: var(--lights-blue-color);
  transition: fill 0.6s ease-out;
}

#cityscape-lights-pink-one > path,
#cityscape-lights-pink-two > path,
#cityscape-lights-pink-three > path {
