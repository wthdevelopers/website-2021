<template>
  <nav>
    ...
    <div id="drawer">
      ...
      <svg id="cancel" @click="closeDrawer" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
        <path
...
export default Vue.extend({
  ...
  methods: {
    ...
    openDrawer(): void {
      let drawerContext = <HTMLElement>document.querySelector("#drawer-context");
      let drawer = <HTMLElement>document.querySelector("#drawer");
      drawerContext.style.display = "block";
      setTimeout(() => {
        drawerContext.style.opacity = "0.5";
      }, 100);
